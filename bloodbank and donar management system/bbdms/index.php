...
<head>
    ...
    <title>Friends Blood Bank</title>
...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to Friends Blood Bank</h1>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">The need for blood</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Approximately 36,000 units of red blood cells are needed every day in the U.S. Nearly 7,000 units of platelets and 10,000 units of plasma are needed daily in the india. Nearly 21 million blood components are transfused each year in the india. The average red blood cell transfusion is approximately 3 units. </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
